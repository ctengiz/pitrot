        ...
        <div class="panel panel-info">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <a href="/client/{{arec.code}}/issues?status_code={{rw.code}}">{{rw.nro}} - {{rw.code}}</a>
                ...
                <div class="panel-group" role="tablist" aria-multiselectable="true" id="accordion">
                    ...
                    %for rw in prj_summary:
                        %if tcode != rw.project_code:
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading" role="tab" id="t{{rw.project_id}}">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse"
                                        href="#{{rw.project_id}}"
                                       aria-expanded="true" aria-controls="{{rw.project_id}}"
                                    >
                                    </a>
                                ...
                                <div id="{{rw.project_id}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="{{rw.project_id}}">
                                    <ul class="list-group">
                        %end
                        <li class="list-group-item">
                ...
                <div class="panel-group" role="tablist" aria-multiselectable="true" id="accordion_user">
                    ...
                    %for rw in usr_summary:
                        ...
                        <li class="list-group-item">
                            <span class="badge">{{rw.cnt}}</span>
                            %if rw.usr_code_assigned:
                                <a href="/client/{{arec.code}}/issues?status_code={{rw.code}}&usr_id_assigned={{rw.usr_id_assigned}}">
                                    {{rw.nro}} - {{rw.code}}
                                </a>
                            %else:
                                <a href="/client/{{arec.code}}/issues?status_code={{rw.code}}&ck_unassigned=on">
                                    {{rw.nro}} - {{rw.code}}
                                </a>
                            %end
                        </li>
